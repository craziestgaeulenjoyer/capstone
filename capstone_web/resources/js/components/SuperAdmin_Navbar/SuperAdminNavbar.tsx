          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center pt-4">
              <button
                ...
                className="cursor-pointer px-6 py-2 rounded-md bg-[#8cb662] text-white hover:bg-[#7ca551]"
              >
                OK
              </button>
            </div>
        ...
        <Modal onClose={() => setShowOtpModal(false)}>
          <div className="space-y-4">
            ...
            <input
              ...
              className="text-gray-900 w-full border-gray-400 border-2 rounded-lg px-4 py-2 text-center tracking-widest text-lg"
              placeholder="••••••"
            />
            ...
            <div className="flex justify-end gap-3 pt-4">
              <button
                ...
                className="cursor-pointer px-4 py-2 rounded-md bg-gray-300 text-gray-700 hover:bg-gray-200 hover:text-gray-900"
              >
                Cancel
              </button>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col items-center space-y-3 mt-6">
              ...
              <input
                ...
                className="w-[80%] text-gray-900 border-gray-300 border-2 rounded-lg px-4 py-2 mb-4 mt-2"
              />
            </div>
