    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-xl w-full p-8 text-center flex flex-col items-center">
        ...
        <div className="self-start mb-8">
          <Link href="/" className="text-[#8CB662] hover:text-[#648641]"> 
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          You've entered <span className="font-medium text-black">{userEmail}</span> as the email address for your account.
          <br />
      ...
      >
        <button
          ...
          className="px-8 py-3 bg-white text-[#8CB662] rounded-full
                          border-2 border-[#8CB662] shadow-md font-extrabold
