  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-200 p-4">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-xl w-full p-8 text-center flex flex-col items-center">
        ...
        <div className="mb-2">
          <img src="/images/Emails-amico.png" alt="Email Verification Illustration" className="max-w-full h-[200px]" />
        
        </div>

        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Verify your email address</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
          You've entered <span className="font-medium text-[#619e23]">{userEmail}</span> as the email address for your account.
          <br />
      ...
      >
        <button
          type="button"
          className="px-8 py-3 bg-white text-[#8CB662] rounded-full
