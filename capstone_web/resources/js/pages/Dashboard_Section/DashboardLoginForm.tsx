...
const DashboardLoginForm = () => {
  ...
  return (
    // Changed h-screen to min-h-screen for mobile scrolling support
      ...
      <div className="flex flex-col lg:flex-row bg-white rounded-xl shadow-2xl overflow-hidden max-w-4xl w-full">
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-10 flex flex-col justify-center order-2 lg:order-1">
          <div className="flex justify-between items-center mb-8">
            <Link href="/dashboardgetstarted" className="text-[#8CB662] hover:text-[#b7f777] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
            </Link>
            <img src="/images/MiAmore2.png" alt="Mi Amore Cafe Logo" className="h-12 w-12 sm:h-15 sm:w-15" />
          </div>

          <h2 className="text-xl sm:text-2xl font-bold text-[#8CB662]">Login to continue</h2>
          <p className="text-gray-600 text-sm sm:text-md mb-6 sm:mb-8 leading-relaxed">
          ...
          <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-900 placeholder-gray-400
                           focus:outline-none focus:ring-2 focus:ring-[#8CB662] focus:border-transparent bg-white text-sm sm:text-base"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  id="password"
                  className="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-900 placeholder-gray-400
                             focus:outline-none focus:ring-2 focus:ring-[#8CB662] focus:border-transparent pr-10 bg-white text-sm sm:text-base"
                ...
                >
                  {showPassword ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c1.99 0 3.87-.54 5.47-1.477M6.228 6.228A9.956 9.956 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.52 10.52 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228L21 21" />
                    </svg>
                  ) : (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 text-xs sm:text-sm">
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="rememberMe"
                  className="h-4 w-4 text-[#8CB662] focus:ring-[#8CB662] border-gray-300 rounded cursor-pointer"
                  checked={rememberMe}
              ...
              <Link href="/dashboardforgotpassword" className="text-[#8CB662] hover:underline font-medium">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-8 py-3 bg-white text-[#8CB662] rounded-full border border-[#8CB662] shadow-sm font-bold
                         hover:bg-[#8CB662] hover:text-white hover:shadow-md focus:outline-none focus:ring-2
                         focus:ring-[#8CB662] focus:ring-opacity-75 transition duration-300 ease-in-out transform hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="w-full lg:w-1/2 bg-[#8CB662] p-8 sm:p-10 flex flex-col items-center justify-center text-white text-center order-1 lg:order-2">
          <div className="mb-6 lg:mb-8">
            <img 
               ...
               className="max-w-[180px] sm:max-w-[250px] lg:max-w-full h-auto drop-shadow-lg" 
            />
          </div>

          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 leading-tight">Welcome to Mi Amore Café</h1>
          <p className="text-lg sm:text-xl lg:text-2xl font-light italic opacity-90">Admin Portal</p>
        </div>
      </div>
    </div>
  );
