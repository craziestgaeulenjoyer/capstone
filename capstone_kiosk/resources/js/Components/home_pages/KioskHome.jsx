...
export default function KioskHome() {
  // Siguraduhin na ang names dito ay tugma sa categories mo sa KioskMenu
  const menuItems = [
    { id: 'c1', name: "Specialty Coffee", image: "/images/SpecialtyCoffee.png" },
    { id: 'c2', name: "Milk Tea", image: "/images/MilkTea.png" },
    { id: 'c3', name: "Lemonade & Fruit Juices", image: "/images/Lemonade_FruitJuices.png" },
    { id: 'c4', name: "Coffee", image: "/images/Coffee.png" },
    { id: 'c5', name: "Premium Matcha", image: "/images/PremiumMatcha.png" },
    { id: 'c6', name: "Snacks", image: "/images/Snacks.png" },
    { id: 'c7', name: "Croffles", image: "/images/Croffles.png" },
    { id: 'c8', name: "Quesadillas & Corndogs", image: "/images/Quesadillas_Corndogs.png" },
  ...
  return (
    <div className="h-screen w-screen bg-[#FDFCF8] font-serif flex flex-col overflow-hidden text-[#3D2317] select-none">
      ...
      <header className="bg-white border-b border-[#8CB662]/20 px-8 py-6 flex justify-between items-center shrink-0 z-30 shadow-sm">
        <button onClick={() => window.history.back()} className="flex items-center text-[#8CB662] font-bold hover:opacity-70 transition-opacity">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-10 bg-[#FDFCF8]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 flex flex-col items-center">
              <h2 className="text-4xl font-black italic uppercase tracking-tighter text-[#3D2317]">Browse Menu</h2>
