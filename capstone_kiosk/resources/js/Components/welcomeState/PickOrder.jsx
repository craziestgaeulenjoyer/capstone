 ...
 const handleSelect = (option) => {
  setSelectedOption(option);
    ...
    if (option === "dinein") {
      ...
      localStorage.removeItem("is_bulk_order");
    }

    if (option === "takeout") {
      fulfillmentMethod = "Take out";
      localStorage.removeItem("is_bulk_order");
    }
    ...
    if (option === "bulk") {
      ...
      // 🔴 IMPORTANT FLAG
      localStorage.setItem("is_bulk_order", "true");

      // 🔁 Always go back to kiosk home
      redirectTo = "/kioskhome";
    }
